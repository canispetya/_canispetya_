  ...
  return (
    <section id="about" className="h-[100dvh] w-screen flex flex-col justify-center items-center relative overflow-hidden bg-background">
      ...
      <div className="z-10 text-center flex flex-col items-center">
        ...
        <h1 className="text-[8vw] sm:text-[10vw] md:text-7xl lg:text-8xl w-full max-w-[100vw] font-display font-black text-foreground uppercase mb-2 sm:mb-6 leading-none text-glow mix-blend-screen mix-blend-difference filter drop-shadow-[0_0_30px_rgba(227,66,52,0.8)] px-2 sm:px-4 whitespace-nowrap text-center">
        ...
        <p className="w-full max-w-[90vw] md:max-w-xl text-xs sm:text-sm md:text-lg text-gray-300 font-sans mt-4 md:mt-8 px-2 md:px-4 opacity-80 leading-relaxed text-center box-border">
          Creo aplicaciones web de alto rendimiento que abrazan el caos de los sistemas escalables modernos. Desarrollador full-stack especializado en React, Node y Supabase.
        </p>
